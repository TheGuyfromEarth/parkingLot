...
/**
 * Driver class used to test lab8.District and lab8.ParkingLot classes.
...
public class ParkingDriver {
    ...
    public static void main(String[] args) {
        // Testing lab8.ParkingLot class
        testSmallLot();
        testOverfillingLot();
        testParkingLot();
        testComingAndGoing();
        // Testing lab8.District class
        testTinyDistrict();
        testDistrict();
        testHeavyUsage();
    ...
    private static void testSmallLot() {
        ...
        if(!driveway.getName().equals("Blacktop")) {
            displayError("lab8.ParkingLot.getName() not working, expected 'Blacktop' not '"
                    + driveway.getName() + "'.");
        }
    ...
    /**
     * Uses other static methods to test the lab8.ParkingLot class.
    ...
    private static void testTinyDistrict() {
        displayMessage("Testing Tiny lab8.District...");
        ...
        displayMessage("Finished Testing Tiny lab8.District\n");
    }

    /**
     * Test lab8.District class
     */
    public static void testDistrict() {
        displayMessage("Finished Testing Normal lab8.District...");
    ...
    private static void testHeavyUsage() {
        displayMessage("Finished Testing Heavily Used lab8.District...");
    ...
    private static void testFillingLot(ParkingLot lot) {
        displayMessage("Testing lab8.ParkingLot");
